...
import 'package:flutter_quests/ui/screens/create_step/step_builder/geolocation_step_builder/geolocation_step_builder.dart';
    ...
    return Column(
      children: [
        ...
        if (step is SlideStepModel)
          SlideStepBuilder(step: step as SlideStepModel),
        if (step is GeolocationStepModel)
          GeolocationStepBuilder(
